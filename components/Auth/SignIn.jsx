const SignInCard = () => {
	return (
		<div
			className={`mx-auto h-[20rem] max-w-sm rounded-2xl shadow-lg flex flex-col 
      ...
      tracking-wider overflow-hidden`}
		>
			...
			<div className="h-10 shadow-lg my-5 bg-white rounded-full flex items-center justify-between px-1 relative cursor-pointer poppins tracking-wider z-10 text-sm sm:text-base text-gray-700">
				<img
					src="/images/google.png"
					alt="Sign in with google"
					className={`block h-3/5 mx-3`}
				/>
