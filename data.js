export default [
	{
		...
		problems: [
			...
			{
				desc: 'Find the maximum and minimum element in an array',
			...
			{
				desc: 'Next Permutation',
				link: 'https://leetcode.com/problems/next-permutation/',
			},
			{
				desc: 'Count Inversion',
			...
			{
				desc: 'find common elements In 3 sorted arrays',
			...
			{
				desc: 'Find if there is any subarray with sum equal to 0',
				link: 'https://practice.geeksforgeeks.org/problems/subarray-with-0-sum/0',
			},
			{
				desc: 'Find factorial of a large number',
			...
			{
				desc: 'Find longest coinsecutive subsequence',
			...
			{
				desc: 'Minimum no. of operations required to make an array palindrome',
				link: 'https://practice.geeksforgeeks.org/problems/palindromic-array/0',
			},
			{
				desc: 'Median of 2 sorted arrays of equal size',
				link: 'https://practice.geeksforgeeks.org/problems/find-the-median0527/1',
			},
			{
				desc: 'Median of 2 sorted arrays of different size',
	...
	},
	{
		...
		problems: [
			...
			{
				desc: 'Check whether a String is Palindrome or not',
				link: 'https://practice.geeksforgeeks.org/problems/palindrome-string0817/1',
			},
			{
				desc: 'Find Duplicate characters in a string',
			...
			{
				desc: 'Find Longest Recurring Subsequence in String',
				link: 'https://practice.geeksforgeeks.org/problems/longest-repeating-subsequence/0',
			},
			{
				desc: 'Print all Subsequences of a string.',
				link: 'https://www.geeksforgeeks.org/print-subsequences-string/',
			},
			{
				desc: 'Print all the permutations of the given string',
			...
			{
				desc: 'Word Wrap Problem [VERY IMP].',
				link: 'https://practice.geeksforgeeks.org/problems/word-wrap/0',
			},
			{
				desc: 'EDIT Distance [Very Imp]',
			...
			{
				desc: 'Given a sequence of words, print all anagrams together',
			...
			{
				desc: 'Recursively remove all adjacent duplicates',
				link: 'https://practice.geeksforgeeks.org/problems/consecutive-elements/0',
			},
			{
				desc: 'String matching where one string contains wildcard characters',
			...
			{
				desc: 'Check if two given strings are isomorphic to each other',
	...
	},
	{
		...
		problems: [
			{
				desc: 'Find first and last positions of an element in a sorted array',
				link: 'https://practice.geeksforgeeks.org/problems/first-and-last-occurrences-of-x/0',
			},
			{
				desc: 'Find a Fixed Point (Value equal to index) in a given array',
				link: 'https://practice.geeksforgeeks.org/problems/value-equal-to-index-value1330/1',
			},
			{
				desc: 'Search in a rotated sorted array',
				link: 'https://leetcode.com/problems/search-in-rotated-sorted-array/',
			},
			{
				desc: 'square root of an integer',
			...
			{
				desc: 'Optimum location of point to minimize total distance',
			...
			{
				desc: 'Kth smallest number again',
			...
			{
				desc: 'Find pivot element in a sorted array',
				link: 'http://theoryofprogramming.com/2017/12/16/find-pivot-element-sorted-rotated-array/',
			},
			{
				desc: 'K-th Element of Two Sorted Arrays',
				link: 'https://practice.geeksforgeeks.org/problems/k-th-element-of-two-sorted-array/0',
			},
			{
				desc: 'Aggressive cows',
				link: 'https://www.spoj.com/problems/AGGRCOW/',
			},
			{
				desc: 'Book Allocation Problem',
				link: 'https://practice.geeksforgeeks.org/problems/allocate-minimum-number-of-pages/0',
			},
			{ desc: 'EKOSPOJ:', link: 'https://www.spoj.com/problems/EKO/' },
			{
				desc: 'Job Scheduling Algo',
				link: 'https://www.geeksforgeeks.org/weighted-job-scheduling-log-n-time/',
			},
			{
				desc: 'Missing Number in AP',
				link: 'https://practice.geeksforgeeks.org/problems/arithmetic-number/0',
			},
			{
				desc: 'Smallest number with atleastn trailing zeroes infactorial',
				link: 'https://practice.geeksforgeeks.org/problems/smallest-factorial-number5929/1',
			},
			{
				desc: 'Painters Partition Problem:',
				link: 'https://practice.geeksforgeeks.org/problems/allocate-minimum-number-of-pages/0',
			},
			{ desc: 'ROTI-Prata SPOJ', link: 'https://www.spoj.com/problems/PRATA/' },
			{
				desc: 'DoubleHelix SPOJ',
				link: 'https://www.spoj.com/problems/ANARC05B/',
			},
			{ desc: 'Subset Sums', link: 'https://www.spoj.com/problems/SUBSUMS/' },
			{
				desc: 'Findthe inversion count',
				link: 'https://practice.geeksforgeeks.org/problems/inversion-of-array/0',
			},
			{
				desc: 'Implement Merge-sort in-place',
				link: 'https://www.geeksforgeeks.org/in-place-merge-sort/',
			},
			{
				desc: 'Partitioning and Sorting Arrays with Many Repeated Entries',
	...
	},
	{
		...
		problems: [
			...
			{
				desc: 'Add “1” to a number represented as a Linked List.',
	...
	},
	{
		...
		problems: [
			...
			{
				desc: 'Check if Binary tree is Sum tree or not',
				link: 'https://practice.geeksforgeeks.org/problems/sum-tree/1',
			},
			{
				desc: 'Check if all leaf nodes are at same level or not',
			...
			{
				desc: 'Check if 2 trees are mirror or not',
			...
			{
				desc: 'Check if given graph is tree or not. [ IMP ]',
			...
			{
				desc: 'Find Largest subtree sum in a tree',
			...
			{
				desc: 'Print all "K" Sum paths in a Binary tree',
	...
	},
	{
		...
		problems: [
			...
			{
				desc: 'Find the median of BST in O(n) time and O(1) space',
				link: 'https://www.geeksforgeeks.org/find-median-bst-time-o1-space/',
			},
			{
				desc: 'Count BST ndoes that lie in a given range',
	...
	},
	{
		...
		problems: [
			...
			{
				desc: 'Program for Shortest Job First (or SJF) CPU Scheduling',
				link: 'https://www.geeksforgeeks.org/program-for-shortest-job-first-or-sjf-cpu-scheduling-set-1-non-preemptive/',
			},
			{
				desc: 'Program for Least Recently Used (LRU) Page Replacement algorithm',
				link: 'https://practice.geeksforgeeks.org/problems/page-faults-in-lru/0',
			},
			{
				desc: 'Smallest subset with sum greater than all other elements',
			...
			{
				desc: 'Find maximum sum possible equal sum of three stacks',
	...
	},
	{
		...
		problems: [
			...
			{
				desc: 'Find if there is a path of more than k length from a source',
				link: 'https://www.geeksforgeeks.org/find-if-there-is-a-path-of-more-than-k-length-from-a-source/',
			},
			{
				desc: 'Longest Possible Route in a Matrix with Hurdles',
			...
			{
				desc: 'Partition of a set intoK subsets with equal sum',
				link: 'https://practice.geeksforgeeks.org/problems/partition-array-to-k-subsets/1',
			},
			{
				desc: 'Find the K-th Permutation Sequence of first N natural numbers',
	...
	},
	{
		...
		problems: [
			...
			{
				desc: 'Evaluation of Postfix expression',
			...
			{
				desc: 'Reverse a stack using recursion',
				link: 'https://www.geeksforgeeks.org/reverse-a-stack-using-recursion/',
			},
			{
				desc: 'Sort a Stack using recursion',
			...
			{
				desc: 'Implement "n" queue in an array',
			...
			{
				desc: 'LRU Cache Implementationa',
				link: 'https://practice.geeksforgeeks.org/problems/lru-cache/1',
			},
			{
				desc: 'Reverse a Queue using recursion',
	...
	},
	{
		...
		problems: [
			{
				desc: 'Implement a Maxheap/MinHeap using arrays and recursion.',
				link: 'https://www.geeksforgeeks.org/building-heap-from-array/',
			},
			{
				desc: 'Sort an Array using heap. (HeapSort)',
			...
			{
				desc: 'Minimum sum of two numbers formed from digits of an array',
	...
	},
	{
		...
		problems: [
			...
			{
				desc: 'Search in a Maze',
				link: 'https://practice.geeksforgeeks.org/problems/rat-in-a-maze-problem/1',
			},
			{
				desc: 'Minimum Step by Knight',
				link: 'https://practice.geeksforgeeks.org/problems/steps-by-knight/0',
			},
			{
				desc: 'flood fill algo',
			...
			{
				desc: 'Water Jug problem using BFS',
	...
	},
	{
		...
		problems: [
			...
			{
				desc: 'Implement a Phone Directory',
				link: 'https://practice.geeksforgeeks.org/problems/phone-directory/0',
			},
			{
				desc: 'Print unique rows in a given boolean matrix',
	...
	},
	{
		...
		problems: [
			{
				desc: 'Count set bits in an integer',
			...
			{
				desc: 'Calculate square of a number without using *, / and pow()',
